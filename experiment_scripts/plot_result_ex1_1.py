...
# Define colors
LABEL_COLORS = ['Astar', 'Reordering', 'Shortcut Reconstruction', 'Reorder+Shortcut']
TIME_COLORS = ['lightskyblue', 'lightcoral', 'palegreen', 'gold']
PATH_COLORS = ['lightskyblue', 'lightcoral', 'palegreen', 'gold']
ANGLE_COLORS = ['lightskyblue', 'lightcoral', 'palegreen', 'gold']

# TIME_COLORS = ['lightskyblue', 'salmon', 'limegreen', 'gold']
# PATH_COLORS = ['lightskyblue', 'salmon', 'limegreen', 'gold']
# ANGLE_COLORS = ['lightskyblue', 'salmon', 'limegreen', 'gold']
...
for col, exp_name in enumerate(EXP_NAMES):
    ...
    if col == 0:
        axes[0, col].legend(loc='lower center', bbox_to_anchor=(1.4, 1.2), ncol=4, fontsize=15)
