...
class AStarSimple:
    def __init__(self, start, goal, grid):
        ...
        self.neighbor_offsets = [
            (1, 0, 0),  # Move along the x-axis (positive direction)
            (-1, 0, 0), # Move along the x-axis (negative direction)
            (0, 1, 0),  # Move along the y-axis (positive direction)
            (0, -1, 0), # Move along the y-axis (negative direction)
            (0, 0, 1),  # Move along the z-axis (positive direction)
            (0, 0, -1)  # Move along the z-axis (negative direction)
        ]
